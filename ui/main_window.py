...
class MainWindow(QMainWindow):
    ...
    def _setup_ui_documento(self):
        ...
        self.documento_formatacao.setFixedHeight(40)
    ...
    def _setup_ui_documento_formatacao(self):
        ...
        layout_formatacao.addWidget(self.btn_salvar)
        layout_formatacao.addWidget(self.btn_imprimir)
        layout_formatacao.addWidget(separador1)
        ...
        layout_formatacao.addWidget(separador2)
